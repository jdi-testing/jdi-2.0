...
public class RollerTest extends InitTests {
    ...
    public void leftRollerChangeTest(int rollerPosition) {
        ...
        new TestNG("Actual Log Info").matches(actionsLog.get(0), "([0-9]{2}:){2}[0-9]{2} Range 2\\(From\\):" + rollerPosition + " link clicked");
    }
    ...
    public void rightRollerChangeTest(int rollerPosition) {
        ...
        new TestNG("Actual Log Info").matches(actionsLog.get(0), "([0-9]{2}:){2}[0-9]{2} Range 2\\(To\\):" + rollerPosition + " link clicked");
    }
    ...
    public void bothRollersChangeTest(int leftRollerPosition, int rightRollerPosition) {
        ...
        new TestNG("Actual Log Info").matches(actionsLog.get(0), "([0-9]{2}:){2}[0-9]{2} Range 2\\(From\\):" + leftRollerPosition + " link clicked");
        contactForm.setRightRollerPosition(rightRollerPosition);
        new TestNG("Actual Log Info").matches(actionsLog.get(0), "([0-9]{2}:){2}[0-9]{2} Range 2\\(To\\):" + rightRollerPosition + " link clicked");
    }
