...
import static com.epam.jdi.uitests.web.selenium.driver.get.OsTypes.*;
import static com.epam.jdi.uitests.web.selenium.driver.get.Platform.X32;
...
public class DriverData {
    ...
    public static JFunc<EdgeOptions> EDGE_OPTIONS = () -> {
        EdgeOptions cap = new EdgeOptions();
        //cap.setCapability("requireWindowFocus", true);
        cap.setPageLoadStrategy(PAGE_LOAD_STRATEGY.toString());
        cap.setCapability(ACCEPT_SSL_CERTS, true);
        cap.setCapability(UNEXPECTED_ALERT_BEHAVIOR, true);
        cap.is(SUPPORTS_JAVASCRIPT);
        return cap;
    };
    public static JFunc<OperaOptions> OPERA_OPTIONS = OperaOptions::new;
    public static JFunc<PhantomJSDriverService> PHANTOM_JS_OPTIONS =
